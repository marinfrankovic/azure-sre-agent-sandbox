...
echo ""
echo "Managed Grafana (public endpoint, secured by Entra ID + RBAC)"
...
echo "  4. Connect the agent to Grafana MCP at the endpoint above using the agent's"
echo "     managed identity (it already holds Grafana Viewer)."
echo "==============================================================="
